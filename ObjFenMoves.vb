...
#Region "Déclaration des variables"
    ...
    Public Board10x10(100) As Char 'contient l'initiale de la pièce correspondante en notation anglaise K Q R ...

    'permet de gerer le mode de suivit sans vérification du camp au trait 
    'TODO a revoir
    Public onLive As Boolean = False
...
#Region "Gestion des mouvements"
    ...
    Private Function Kmoves(ByVal sqIndex As Byte) As String
        ...
        If SquareName(sqIndex) = "e1" Then
            ...
            If onLive Then
                If Board10x10(sqIndex + dpl.RIGHT) = "R" Then
                    AddMoves(sqIndex, dpl.RIGHT * 2, TempoMoves)
                End If

                If Board10x10(sqIndex + dpl.LEFT) = "R" Then
    ...
    Private Function Rmoves(ByVal sqIndex As Byte) As String
        ...
        'TODO ou pas 
        If onLive Then
            If SquareName(sqIndex) = "h1" Then
                If Board10x10(sqIndex + dpl.LEFT) = "K" Then
                    AddMove(sqIndex + dpl.LEFT * 2, sqIndex, TempoMoves)
                End If
            End If
            If SquareName(sqIndex) = "a1" Then
                If Board10x10(sqIndex + dpl.RIGHT * 2) = "K" Then
                    AddMove(sqIndex + dpl.RIGHT * 3, sqIndex, TempoMoves)
                End If
            End If
            If SquareName(sqIndex) = "h8" Then
                If Board10x10(sqIndex + dpl.LEFT) = "k" Then
                    AddMove(sqIndex + dpl.LEFT * 2, sqIndex, TempoMoves)
                End If
            End If
            If SquareName(sqIndex) = "a8" Then
                If Board10x10(sqIndex + dpl.RIGHT * 2) = "k" Then
                    AddMove(sqIndex + dpl.RIGHT * 3, sqIndex, TempoMoves)
                End If
            End If
    ...
    Private Function Pmoves(ByVal sqIndex As Byte) As String
        ...
        If ColorOf(sqIndex) = 1 Then
            ...
            If onLive Then
                If sqIndex > 30 Then AddMove(sqIndex + dpl.DOWN, sqIndex, TempoMoves, False)
                If sqIndex > 40 Then AddMove(sqIndex + dpl.DOWN * 2, sqIndex, TempoMoves, False)
            End If
        End If
        ...
        If ColorOf(sqIndex) = 2 Then
            ...
            If onLive Then
                If sqIndex < 70 Then AddMove(sqIndex + dpl.UP, sqIndex, TempoMoves, False)
                If sqIndex < 60 Then AddMove(sqIndex + dpl.UP * 2, sqIndex, TempoMoves, False)
            End If
    ...
    Public Function GetAllRecs() As String
        ...
        For iSquare = 11 To 88
            If onLive Then
                ...
                Recs = GetRecs(SquareName(iSquare))
                If Recs <> "" Then
                    tempo = tempo & "|" & Recs
                End If
        ...
        If AllMoves.Length > 0 Then
            ...
            For i = 0 To aMove.Count - 1
                If aMove(i).Substring(0, 1) = "x" Then
                    If IsValidMove(strSquare & aMove(i).Substring(1, 2)) Or onLive Then
                        tmp &= aMove(i) & " "
                    End If
                Else
                    If IsValidMove(strSquare & aMove(i)) Or onLive Then
                        tmp &= aMove(i) & " "
                    End If
                End If
